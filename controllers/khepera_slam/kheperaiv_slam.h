#ifndef KHEPERAIV_SLAM_H
#define KHEPERAIV_SLAM_H
...
#include "BreezySLAM/cpp/WheeledRobot.hpp"
#include "BreezySLAM/cpp/Velocities.hpp"
 ...
 */
class CKheperaIVSlam : public CCI_Controller {
...
private:
   ...
   //Byte array for storing map
   unsigned char * m_pcMapbytes;

   SinglePositionSLAM * m_pcSlam;
